...
const MESSAGES = {
    ...
    NOT_INSERTED: (key, value) => ({
        message: `Resource ${key} ${value}  not inserted`,
    ...
    NOT_REMOVED: (key, value) => ({
        message: `No resource ${key} ${value}  was found`,
        code: CODES.NOT_REMOVED,
        type: 'error'
    }),
    KEY_NO_NOT_MATCH: (key, keyInResource) => ({
        message: `The key ${key} of given Resource doesn't match the given key in ${keyInResource} `,
